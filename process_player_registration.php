<?php
    ...
    $sql = "INSERT INTO players (FirstName, LastName, DateOfBirth, Gender, Email, PhoneNumber, Address, EmergencyContactName, EmergencyContactNumber, MedicalConditions, RegistrationNo)
            VALUES ('$FirstName', '$LastName', '$DateOfBirth', '$Gender', '$Email', '$PhoneNumber', '$Address', '$EmergencyContactName', '$EmergencyContactNumber', '$MedicalConditions', '$RegistrationNo')";
